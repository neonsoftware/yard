...
.factory('Documents', 		['$resource', function($resource) { return $resource( remoteUrl + '/documents/:uuid/:command', 	    {uuid:"@id"},   {update: { method: 'PUT' }, generate: { method: 'POST' }, delete_application: { method: 'DELETE' } } ); } ] );