...
;
  (function () {
    Polymer({
      ...
      ready: function() {
        if(this.debug) console.log('app-list : ready');
  ...
  (function () {
    Polymer({
      ...
      computeGetUrl:function(currentId){
        var new_get_url = ( currentId === "new" ) ? '' : '/pieces/' + String(this.objid);
      ...
      computePushUrl:function(currentId){
        var new_push_url = ( currentId === "new" ) ? '/pieces' : '/pieces/' + currentId + '/';
...
;
  (function () {
    Polymer({
      ...
      _on_content_change: function(new_value, old_value){
        var j, len;
        console.log('Changed content : new value is ', new_value, ' current legend is ', this.currentlegend );
        for (j = 0 , len = this.currentlegend.length; j < len ;  ++j) {
          var currentObject = this.currentlegend[j];
          var currentObjectKey = currentObject.key;
          if(this.debug) console.log("Current object is ", currentObject);
          if(this.debug) console.log("Current object key is ", currentObjectKey);
          if(this.debug) console.log("Comparing  ", this.currentlegend[j].key, 'to ');

          if( this.currentcontent.indexOf(currentObjectKey) >-1 ){
            if(this.debug) console.log("FOOOOOOOUNDDDDDD ");
          }
        }
      ...
      _chhange: function(new_value, old_value){
        console.log('Changed legend : new value is ', new_value );
      }
