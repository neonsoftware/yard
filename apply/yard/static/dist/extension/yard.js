...
;
  (function () {
    Polymer({
      ...
      handleResponseGet:function(response){
        console.log('GET response. Status is', response.detail.status);
        if( response.detail.status == 403 ){
  ...
  (function () {
    Polymer({
      ...
      selectedChanged : function(){
        console.log("Selected language is ", this.$.languagelist.value);
        this.language = this.$.languagelist.value;
      },
    });
  })();
  ...
  (function () {
    Polymer({
      ...
      save_me: function(){
        ...
        console.log("templates-detail :isnew  : ", this.isnew );
        if(this.isnew){
